...
namespace OTEAServer.Models
{
    ...
    /// Version: 1
    /// </summary>
    public class IndicatorsEvaluationEvidenceReg
    {
        /// <summary>
        /// Class constructor
        /// </summary>
        ...
        public IndicatorsEvaluationEvidenceReg(long evaluationDate, int idEvaluatedOrganization, string orgTypeEvaluated, int idEvaluatorTeam, int idEvaluatorOrganization, string orgTypeEvaluator, string illness, int idCenter, int idEvidence, int idIndicator, string indicatorType, int idSubSubAmbit, int idSubAmbit, int idAmbit, int indicatorVersion, int isMarked, string evaluationType,
