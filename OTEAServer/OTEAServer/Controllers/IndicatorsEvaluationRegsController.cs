...
namespace OTEAServer.Controllers
{
    ...
    public class IndicatorsEvaluationRegsController : ControllerBase
    {
        ...
        public IActionResult GetAllByIndicatorsEvaluation(DateTime evaluationDate, int idEvaluatedOrganization, string orgType, string illness) {
        ...
        public ActionResult<IndicatorsEvaluationReg> Delete(DateTime evaluationDate, int idEvaluatedOrganization, string orgType, string illness, int indicatorId, int idEvidence, int indicatorVersion) {
            var indicatorsEvaluation = _IndicatorsEvaluationRegsService.Get(evaluationDate, idEvaluatedOrganization, orgType, illness, indicatorId, idEvidence, indicatorVersion);
