...
namespace OTEAServer.Controllers
{
    ...
    public class IndicatorsEvaluationsController : ControllerBase
    {
        ...
        {
            var indicatorsEvaluations = _indicatorsEvaluationsService.GetAllByEvaluatorOrganization(idEvaluatorOrganization, orgType, illness);
            return Ok(indicatorsEvaluations);
        }
        ...
        {
            _indicatorsEvaluationsService.Add(indicatorsEvaluation.evaluationDate, indicatorsEvaluation.idEvaluatedOrganization, indicatorsEvaluation.orgTypeEvaluated, indicatorsEvaluation.idEvaluatorTeam, indicatorsEvaluation.idEvaluatorOrganization, indicatorsEvaluation.orgTypeEvaluator, indicatorsEvaluation.illness, indicatorsEvaluation.scoreLevel1, indicatorsEvaluation.scoreLevel2, indicatorsEvaluation.scoreLevel3, indicatorsEvaluation.scoreLevel4, indicatorsEvaluation.scoreLevel5, indicatorsEvaluation.scoreLevel6, indicatorsEvaluation.totalScore);
