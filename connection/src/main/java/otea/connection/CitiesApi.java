...
public interface CitiesApi {
    ...
    @GET("Cities/idCity={idCity}:idProvince={idProvince}:idRegion={idRegion}:idCountry={idCountry}")
    ...
    @GET("Cities/idProvince={idProvince}:idRegion={idRegion}:idCountry={idCountry}")
