...
public class SelectToSeeRealizedIndicatorsEvaluations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isAMiradasUser) {
            ...
            organizations.add(Session.getInstance().getOrganization());
        }
        ...
        if(isAMiradasUser) {
            ...
            centers=CentersController.GetAllByOrganization(evaluatedOrganization[0]);
                            ...
                            new Thread(()->{
                                ...
                                runOnUiThread(() -> {
                                    ...
                                    if (evaluatorTeams.size() == 1) {
                                        spinnerEvaluatorTeam.setVisibility(View.GONE);
                                        spinnerEvaluatorTeamAux.setVisibility(View.VISIBLE);
                                        new AwesomeWarningDialog(SelectToSeeRealizedIndicatorsEvaluations.this)
        ...
        spinnerEvaluatorTeam.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position>0){
                    ...
                    IndicatorsEvaluationsController.GetAllByEvaluatorTeam(evaluatorTeam[0].getIdEvaluatorTeam(), evaluatorTeam[0].getIdEvaluatorOrganization(), evaluatorTeam[0].getOrgTypeEvaluator(), evaluatorTeam[0].getIdEvaluatedOrganization(), evaluatorTeam[0].getOrgTypeEvaluated(), evaluatorTeam[0].getIdCenter(), evaluatorTeam[0].getIllness(), new ListCallback() {
                        @Override
                        public void onSuccess(List<JsonObject> data) {
                            new Thread(()->{
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AwesomeProgressDialog dialog=new AwesomeProgressDialog(SelectToSeeRealizedIndicatorsEvaluations.this)
                ...
                if(evaluatedOrganization[0].getIdOrganization()==-1 || center[0]==null || center[0].getIdCenter()==-1 || evaluatorTeam[0]==null || evaluatorTeam[0].getIdEvaluatorTeam()==-1 || indicatorsEvaluation[0]==null || indicatorsEvaluation[0].getIdCenter()==-1){
                    ...
                    new AwesomeErrorDialog(SelectToSeeRealizedIndicatorsEvaluations.this)
                            .setTitle(idTitle)
