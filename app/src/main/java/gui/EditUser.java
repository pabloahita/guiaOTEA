                ...
                v.postDelayed(new Runnable(){
                    ...
                    public void run(){
                        ...
                        if(!first_name.equals("") && !last_name.equals("") && FieldChecker.passwordHasCorrectFormat(password) && FieldChecker.isACorrectPhone(telephone[0]+telephone[1])){
                            ...
                            User usr=new User(user.getEmailUser(),user.getUserType(),first_name,last_name, PasswordFormatter.codify(password),telephone[0]+" "+telephone[1],user.getIdOrganization(),user.getOrganizationType(),user.getIllness(),imgUsrName);
