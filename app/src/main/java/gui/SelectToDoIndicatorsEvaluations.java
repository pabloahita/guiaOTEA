...
public class SelectToDoIndicatorsEvaluations extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView evalType=findViewById(R.id.eval_type);
        ...
        if(organizations.isEmpty() || organizations.get(0).getIdOrganization()!=-1) {
        ...
        spinnerEvaluatorTeam.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position>0){
                    evalType.setVisibility(View.VISIBLE);
                    if(evaluatorTeam[0].getExternalConsultant().equals("-")){
                        evaluationType[0]="SIMPLE";
                        evalType.setText(R.string.simple_evaluation);
                    }else{
                        evaluationType[0]="COMPLETE";
                        evalType.setText(R.string.full_evaluation);
                    }
                }else{
                    evaluationType[0]="";
                    evalType.setVisibility(View.GONE);
                }
            }
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AwesomeProgressDialog dialog=new AwesomeProgressDialog(SelectToDoIndicatorsEvaluations.this)
                        ...
                        .setCancelable(false);
                dialog.show();
                if(evaluatedOrganization[0]==null || evaluatedOrganization[0].getIdOrganization()==-1 || center[0]==null || center[0].getIdCenter()==-1 || evaluatorTeam[0]==null || evaluatorTeam[0].getIdEvaluatorTeam()==-1){
                    dialog.hide();
                    String msg="<ul>";
                    int numErrors=0;
