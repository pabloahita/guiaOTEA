    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        helpButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String msg="";
                if(Locale.getDefault().getLanguage().equals("es")){
                    msg="Para poder registrar correctamente un centro o servicio, deberá rellenar los siguientes campos:" +
                            "<ul>" +
                            ...
                            "<br>" +
                            "<b>No olvide aceptar que la <i>Fundación Miradas</i> guarde registro de sus datos acorde con la Ley Orgánica de Protección de Datos.</i></b>";
                }else if(Locale.getDefault().getLanguage().equals("fr")){
                    msg="Afin d'inscrire correctement un centre ou un service, vous devez remplir les champs suivants :" +
                            "<ul>" +
                            ...
                            "<br>" +
                            "<b>N'oubliez pas d'accepter que la <i>Fundación Miradas</i> conserve un enregistrement de vos données conformément à la loi organique sur la protection des données.</i></b>";
                }else if(Locale.getDefault().getLanguage().equals("eu")){
                    msg="Zentro edo zerbitzu bat behar bezala erregistratzeko, ondoko eremuak bete behar dituzu:" +
                            "<ul>" +
                            ...
                            "<br>" +
                            "<b>Ez ahaztu onartzea <i>Fundación Miradas</i> zure datuen erregistroa gordetzen duela Datuak Babesteko Lege Organikoaren arabera.</i></b>";
                }else if(Locale.getDefault().getLanguage().equals("ca")){
                    msg="Per poder registrar correctament un centre o servei, haureu d'emplenar els camps següents:" +
                            "<ul>" +
                            ...
                            "<br>" +
                            "<b>No oblideu acceptar que la <i>Fundación Miradas</i> guardi registre de les vostres dades d'acord amb la Llei Orgànica de Protecció de Dades.</i></b>";
                }else if(Locale.getDefault().getLanguage().equals("nl")){
                    msg="Om een \u200B\u200Bcentrum of dienst correct te registreren, moet u de volgende velden invullen:" +
                            "<ul>" +
                            ...
                            "<br>" +
                            "<b>Vergeet niet te accepteren dat de <i>Fundación Miradas</i> uw gegevens bijhoudt in overeenstemming met de organieke wet op de gegevensbescherming.</i></b>";
                }else if(Locale.getDefault().getLanguage().equals("gl")){
                    msg="Para rexistrar correctamente un centro ou servizo é necesario cubrir os seguintes campos:" +
                            "<ul>" +
                            ...
                            "<br>" +
                            "<b>Non esquezas aceptar que a <i>Fundación Miradas</i> leva un rexistro dos teus datos de acordo coa Lei Orgánica de Protección de Datos.</i></b>";
                }else if(Locale.getDefault().getLanguage().equals("de")){
                    msg="Um ein Zentrum oder eine Dienstleistung korrekt zu registrieren, müssen Sie die folgenden Felder ausfüllen:" +
                            "<ul>" +
                            ...
                            "<br>" +
                            "<b>Vergessen Sie nicht zu akzeptieren, dass die <i>Fundación Miradas</i> Aufzeichnungen über Ihre Daten in Übereinstimmung mit dem Datenschutzgesetz führt.</i></b>";
                }else if(Locale.getDefault().getLanguage().equals("it")){
                    msg="Per poter registrare correttamente un centro o un servizio è necessario compilare i seguenti campi:" +
                            "<ul>" +
                            ...
                            "<br>" +
                            "<b>Non dimenticare di accettare che la <i>Fundación Miradas</i> conservi un registro dei tuoi dati in conformità con la Legge organica sulla protezione dei dati.</i></b>";
                }else if(Locale.getDefault().getLanguage().equals("pt")){
                    msg="Para registar corretamente um centro ou serviço é necessário preencher os seguintes campos:" +
                            "<ul>" +
                            ...
                            "<br>" +
                            "<b>Não se esqueça de aceitar que a <i>Fundación Miradas</i> mantenha registos dos seus dados de acordo com a Lei Orgânica de Proteção de Dados.</i></b>";
                }else{
                    msg="In order to correctly register a center or service, you must fill out the following fields:" +
                            "<ul>" +
                            ...
                            "<br>" +
                            "<b>Do not forget to accept that the <i>Fundación Miradas</i> keeps records of your data in accordance with the Organic Law on Data Protection.</i></b>";
                }
                        ...
                        public void onSuccess(List<JsonObject> data) {
                            ...
                            new Thread(()->{
                                ...
                                runOnUiThread(()->{
                                    String msg="";
                                    if(Locale.getDefault().getLanguage().equals("es")){
                                        msg="El centro o servicio <b>"+center.getDescriptionSpanish()+"</b> ha sido registrado satisfactoriamente";
                                    }else if(Locale.getDefault().getLanguage().equals("fr")){
                                        msg="Le centre ou le service <b>"+center.getDescriptionFrench()+"</b> a été enregistré avec succès";
                                    }else if(Locale.getDefault().getLanguage().equals("eu")){
                                        msg="<b>"+center.getDescriptionBasque()+"</b> zentroa edo zerbitzua behar bezala erregistratu da";
                                    }else if(Locale.getDefault().getLanguage().equals("ca")){
                                        msg="El centre o servei <b>"+center.getDescriptionCatalan()+"</b> ha estat registrat satisfactòriament";
                                    }else if(Locale.getDefault().getLanguage().equals("nl")){
                                        msg="Het <b>"+center.getDescriptionDutch()+"</b> centrum of de dienst is succesvol geregistreerd";
                                    }else if(Locale.getDefault().getLanguage().equals("gl")){
                                        msg="O centro ou servizo <b>"+center.getDescriptionGalician()+"</b> rexistrouse correctamente";
                                    }else if(Locale.getDefault().getLanguage().equals("de")){
                                        msg="Das <b>"+center.getDescriptionGerman()+"</b>-Zentrum oder -Dienst wurde erfolgreich registriert";
                                    }else if(Locale.getDefault().getLanguage().equals("it")){
                                        msg="Il centro o il servizio <b>"+center.getDescriptionItalian()+"</b> è stato registrato con successo";
                                    }else if(Locale.getDefault().getLanguage().equals("pt")){
                                        msg="O centro ou serviço <b>"+center.getDescriptionPortuguese()+"</b> foi registado com sucesso";
                                    }else{
                                        msg="The <b>"+center.getDescriptionEnglish()+"</b> center or service has been successfully registered";
                                    }
