...
public class AdminMainMenu extends AppCompatActivity {
    ...
    private ActivityAdminMainMenuBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(
                ...
                .build();
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_activity_admin_main_menu);
