...
public class AddCenter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getCountries();
        countryAdapter[0]= new CountryAdapter(AddCenter.this, countries);
        ...
        Organization organization= OrganizationsCaller.Get(user.idOrganization,user.orgType,user.getIllness());

        centers= CentersCaller.GetAllByOrganization(organization);
        ...
        countrySpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(idCountry[0].equals("ESP")){
                    ...
                    regionAdapter[0]=new RegionAdapter(AddCenter.this, regions);
        ...
        regionSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                provinceAdapter[0]=new ProvinceAdapter(AddCenter.this,provinces);
        ...
        provinceSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {;
                ...
                cityAdapter[0] = new CityAdapter(AddCenter.this, cities);
                ...
                v.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(!centerDescription.equals("") && !addressName.equals("") && !zipCode.equals("") && !nameProvince.equals("") && !nameRegion.equals("") && !nameCity.equals("") && (FieldChecker.isASpanishNumber(telephone) || FieldChecker.isAForeignNumber(telephone))){
                            ...
                            int idOrganization=user.getIdOrganization();
                            ...
                            Center center= new Center(idOrganization,orgType,illness, numCenters[0],centerDescription,idAddress,phone);
                            CentersCaller.Create(center);
                            Intent intent=new Intent(getApplicationContext(),gui.mainMenu.evaluated.MainMenu.class);
