...
namespace WebApplication1
{
    ...
    { /// <summary>
      ...
      /// <param name="profilePhoto">Profile photo</param>
        public UserSession(string emailUser, string userType, string first_name, string last_name, string telephone, int? idOrganization, string? orgType, string? illness, string? profilePhoto, int isActive)
        {
